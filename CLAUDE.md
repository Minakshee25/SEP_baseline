...
- **`amortized_ue/` (new work — Stages 1 & 2 built; cross-LLM transfer characterised end-to-end E20–E33). See `amortized_ue/CLAUDE.md` (current state + to-do) and `EXPERIMENTS.md` (full history E0→E33).**
