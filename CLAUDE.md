...
- **`amortized_ue/` Stage 1 (new work, separate from the baseline):** offline SE dataset build COMPLETE for Llama-2-7b-chat / trivia_qa, N=400 (local + W&B artifact `stage1_records:v0`, run `4d2lvwzc`). See `amortized_ue/CLAUDE.md` for schema, commands, and state.
