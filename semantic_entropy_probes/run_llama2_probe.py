...
ds_paths = [os.path.join(
    REPO,
    'semantic_uncertainty/mn1025/uncertainty/wandb/run-20260624_170438-095l3ou2/files',
)]
...
def main():
    ...
    print("\n" + "=" * 60)
    print(f"PER-LAYER TEST AUROC SUMMARY ({model_name}, {ds_names[0]}, "
          f"N={Ds[0].entropy.shape[0]}) -- real baseline, compare to SEP paper (arXiv:2406.15927)")
    print("=" * 60)
    for D in Ds:
    ...
    save_path = os.path.join(SAVE_DIR, f'{model_name}_probe_inference.pkl')
